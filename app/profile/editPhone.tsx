            ...
            <View style={[styles.container, { backgroundColor: colors.bg }]}>
                ...
                <SafeAreaView style={{ flex: 1 }} edges={["top", "bottom"]}>
                    ...
                    <View style={[styles.header, { borderBottomColor: colors.border }]}>
                        ...
                        <Text style={[styles.heading, { color: colors.text }]}>Phone Number</Text>
                    ...
                    >
                        ...
                        <Text style={[styles.helperText, { color: colors.textSub }]}>
                            Your phone number is used to confirm your identity and help you coordinate rides. It will only be shared with confirmed riders.
                        </Text>
                    </ScrollView>
                </SafeAreaView>
            </View>
